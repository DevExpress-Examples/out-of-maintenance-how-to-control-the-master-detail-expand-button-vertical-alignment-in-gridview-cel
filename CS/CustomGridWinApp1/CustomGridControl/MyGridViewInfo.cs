...
namespace CustomGridControl
{
	public class MyGridViewInfo : GridViewInfo
	{
		...
		protected override void CalcRowCellDrawInfoCore(GridDataRowInfo ri, GridColumnInfoArgs ci, GridCellInfo cell, GridColumnInfoArgs nextColumn, bool calcEditInfo, GridRow nextRow)
		{

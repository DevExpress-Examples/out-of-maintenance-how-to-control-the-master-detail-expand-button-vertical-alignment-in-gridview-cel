...
Namespace CustomGridControl
    Public Class MyGridViewInfo
        ...
        Protected Overrides Sub CalcRowCellDrawInfoCore(ByVal ri As GridDataRowInfo, ByVal ci As GridColumnInfoArgs, ByVal cell As GridCellInfo, ByVal nextColumn As GridColumnInfoArgs, ByVal calcEditInfo As Boolean, ByVal nextRow As GridRow)
            MyBase.CalcRowCellDrawInfoCore(ri, ci, cell, nextColumn, calcEditInfo, nextRow)
            If cell.CellButtonRect = Rectangle.Empty Then
                Return
            End If

            Dim view As MyGridView = TryCast(View, MyGridView)

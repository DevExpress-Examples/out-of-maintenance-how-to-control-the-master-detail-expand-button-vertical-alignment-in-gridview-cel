Namespace CustomGridWinApp1
	Partial Public Class Form1
		...
		Private Sub InitializeComponent()
			...
			Me.myGridView2.OptionsDetail.DetailMode = DevExpress.XtraGrid.Views.Grid.DetailMode.Default
			' 
			' colOrderID
			' 
			...
			Me.myGridView1.OptionsDetail.DetailMode = DevExpress.XtraGrid.Views.Grid.DetailMode.Default
